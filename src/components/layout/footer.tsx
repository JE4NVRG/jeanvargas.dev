      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 px-6 py-8 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.03] text-zinc-400 transition-colors hover:border-white/[0.16] hover:text-white"
            aria-label="GitHub"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.03] text-zinc-400 transition-colors hover:border-emerald-400/30 hover:bg-emerald-400/[0.05] hover:text-emerald-300"
            aria-label="WhatsApp"
