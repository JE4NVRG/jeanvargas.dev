...
export const projects: Project[] = [
  {
    ...
    status: "case",
    scope: { en: "Private case study", pt: "Case privado" },
  ...
  },
  {
    ...
    status: "live",
    scope: { en: "Live business tool", pt: "Ferramenta em uso" },
    dateRange: "2026 — Present",
    category: "SaaS Platform",
  ...
  },
  {
    ...
    status: "internal",
    scope: { en: "Internal tool", pt: "Ferramenta interna" },
  ...
  },
  {
    ...
    status: "demo",
    scope: { en: "Public demo", pt: "Demo publico" },
    dateRange: "2026 — Present",
