...
export const projects: Project[] = [
    ...
    gallery: [
      {
        ...
        title: { en: "Account creation flow", pt: "Fluxo de criacao de conta" },
        description: {
    ...
    gallery: [
      {
        ...
        title: { en: "Tool access page", pt: "Pagina de acesso da ferramenta" },
        description: {
          en: "Beta access flow focused on pricing and operational control.",
          pt: "Fluxo de acesso beta focado em precificacao e controle operacional.",
        },
      },
      {
        src: "/projects/gallery/vultrix-3d-services.png",
        title: { en: "Services surface", pt: "Area de servicos" },
        description: {
          en: "Commercial page connecting services, product, and customer demand.",
          pt: "Pagina comercial conectando servicos, produto e demanda do cliente.",
        },
      },
    ],
  ...
  },
  {
    ...
    status: "live",
    scope: { en: "AI automation", pt: "Automacao com IA" },
    ...
    gallery: [
      {
        ...
        description: {
          ...
          pt: "Estrutura de planos para comecar gratis e escalar com a operacao.",
        },
      },
      {
        ...
        description: {
          ...
          pt: "Pagina de cadastro reforcando metricas e o fluxo central de vendas.",
        },
      },
    ],
